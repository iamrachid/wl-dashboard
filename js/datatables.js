 ...
 *   https://datatables.net/download/#dt/dt-1.13.1/af-2.5.1/date-1.2.0/r-2.4.0/sc-2.0.7
 *
 * Included libraries:
 *   DataTables 1.13.1, AutoFill 2.5.1, DateTime 1.2.0, Responsive 2.4.0, Scroller 2.0.7
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.13.1/af-2.5.1/date-1.2.0/r-2.4.0/sc-2.0.7",
